...
- 放置后**必须**自动告知完整访问链接: `https://openclaw.lazycat1012.heiyu.space/__openclaw__/canvas/文件名.html`
...
### 环境配置
- Canvas 访问域名: https://openclaw.lazycat1012.heiyu.space (通过环境变量 LAZYCAT_APP_DOMAIN 配置)
